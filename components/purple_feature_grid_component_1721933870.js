...
Vue.component("purple_feature_grid_component_1721933870", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the curve with our cutting-edge transaction analysis for the Ethereum blockchain. Receive instant notifications and insights on new transactions as they occur.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Gain a deep understanding of transaction patterns, trends, and anomalies with our powerful analytical tools. Uncover valuable insights to inform your decision-making.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Tailor the app to your specific needs by setting up custom alerts for transactions meeting certain criteria. Never miss an important event.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 text-slate-50 font-medium">User-Friendly Interface</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Navigate the app with ease thanks to our intuitive and user-friendly interface. Access transaction data and insights with just a few clicks.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 text-slate-50 font-medium">Secure and Reliable</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Rest assured that your data is safe with our robust security measures and highly available infrastructure. We prioritize the integrity and privacy of your information.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Seamlessly integrate our transaction analysis capabilities into your existing systems and workflows through our powerful APIs and integration options.</p></div>
        </div>
    </div>`,
        data() {
            return {
